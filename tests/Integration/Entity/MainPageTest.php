...
class MainPageTest extends IntegrationTestCase
{
    ...
    public function testUpdate(): void {
        ...
        $secondLine2ImgFullPath = FileHelper::DIR_PUBLIC . $this->mainPage->secondLine2Img;
        ...
        $fourthLine2ImgFullPath = FileHelper::DIR_PUBLIC . $this->mainPage->fourthLine2Img;
        ...
        $fourthLine3ImgFullPath = FileHelper::DIR_PUBLIC . $this->mainPage->fourthLine3Img;
