...
class MainPageTest extends IntegrationTestCase
{
    ...
    public function testUpdate(): void {
        ...
        $secondLine1 = $this->mainPage->secondLine1;
        $this->assertInstanceOf(Product::class, $secondLine1);
        $this->assertSame($this->product1->id, $secondLine1->id);
        ...
        $thirdLine1 = $this->mainPage->thirdLine1;
        $this->assertInstanceOf(Product::class, $thirdLine1);
        $this->assertSame($this->product2->id, $thirdLine1->id);
        ...
        $secondLine2Img = $this->mainPage->secondLine2Img;
        $this->assertNotNull($secondLine2Img);
        $secondLine2ImgFullPath = $this->imageStorage->getAbsolutePath($secondLine2Img);
        ...
        $fourthLine2Img = $this->mainPage->fourthLine2Img;
        $this->assertNotNull($fourthLine2Img);
        $fourthLine2ImgFullPath = $this->imageStorage->getAbsolutePath($fourthLine2Img);
        ...
        $fourthLine3Img = $this->mainPage->fourthLine3Img;
        $this->assertNotNull($fourthLine3Img);
        $fourthLine3ImgFullPath = $this->imageStorage->getAbsolutePath($fourthLine3Img);
