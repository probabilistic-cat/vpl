    ...
    protected function configureFormFields(FormMapper $form): void {
        ...
        $form
            ...
            ->with('Вторая строка', ['class' => 'col-md-12'])
                ...
                ->add('second_line_3_header', TextType::class, ['label' => 'Блок 3. Заголовок', 'required' => false])
                ->add('second_line_3_text', TextareaType::class, ['label' => 'Блок 3. Текст', 'required' => false])
            ->end()
            ...
            ->with('Четвертая строка', ['class' => 'col-md-12'])
                ->add('fourth_line_1_header', TextType::class, ['label' => 'Блок 1. Заголовок', 'required' => false])
                ->add('fourth_line_1_text', TextareaType::class, ['label' => 'Блок 1. Текст', 'required' => false])
                ->add('fourthLine2ImgFile', FileType::class, $fourthLine2ImgOptions)
                ->add('fourth_line_2_header', TextType::class, ['label' => 'Блок 2. Заголовок', 'required' => false])
                ->add('fourth_line_2_text', TextareaType::class, ['label' => 'Блок 2. Текст', 'required' => false])
                ->add('fourthLine3ImgFile', FileType::class, $fourthLine3ImgOptions)
                ->add('fourth_line_3_header', TextType::class, ['label' => 'Блок 3. Заголовок', 'required' => false])
                ->add('fourth_line_3_text', TextareaType::class, ['label' => 'Блок 3. Текст', 'required' => false])
            ->end()
            //->end()
