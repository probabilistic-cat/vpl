...
final class ProductInfoMiddleGallery extends BaseEntity
{
    use IdField;
    use TimestampFields;

    public const string IMAGE_FOLDER = 'img/product_gallery';
    public const string IMAGE_NAME_PREFIX = 'product_gallery';
